from WB.content.responses import ContentV2GetCardsTrashResponse200Cards
from WB.content.responses import ContentV2GetCardsTrashResponse200Cursor
from dataclasses import dataclass
from typing import List


@dataclass
class ContentV2GetCardsTrashResponse200:
    """
    Список НМ, находящихся в корзине

    Метод позволяет получить список НМ, находящихся в корзине.  <br> <br>Порядок работы. <br> Чтобы получить полный список номенклатур, <b>если их больше 100</b>, необходимо воспользоваться пагинацией.
      <ol>
    ...
    Cards: List[ContentV2GetCardsTrashResponse200Cards]

    Cursor: ContentV2GetCardsTrashResponse200Cursor
